...
import {IVotingRewardsFactory} from "../../../src/interfaces/aerodrome/IVotingRewardsFactory.sol";
import {IGauge} from "../../../src/interfaces/aerodrome/IGauge.sol";
import {IGaugeFactory} from "../../../src/interfaces/aerodrome/IGaugeFactory.sol";
import {IMinter} from "../../../src/interfaces/aerodrome/IMinter.sol";
import {IPool} from "../../../src/interfaces/aerodrome/IPool.sol";
import {IPoolFactory} from "../../../src/interfaces/aerodrome/IPoolFactory.sol";
import {IReward} from "../../../src/interfaces/aerodrome/IReward.sol";
import {IVoter} from "../../../src/interfaces/aerodrome/IVoter.sol";
import {IVotingEscrow} from "../../../src/interfaces/aerodrome/IVotingEscrow.sol";
import {IFactoryRegistry} from "../../../src/interfaces/aerodrome/IFactoryRegistry.sol";
import {IERC20} from "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import {SafeERC20} from "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
import {ERC2771Context} from "@openzeppelin/contracts/metatx/ERC2771Context.sol";
import {ReentrancyGuard} from "@openzeppelin/contracts/utils/ReentrancyGuard.sol";
import {ProtocolTimeLibrary} from "./libraries/ProtocolTimeLibrary.t.sol";

contract MockVoter is IVoter, ERC2771Context, ReentrancyGuard {
    ...
    function createGauge(address _poolFactory, address _pool) external nonReentrant returns (address) {
        ...
        /// NOTE: Commented lines for mocking purposes
    ...
    function _distribute(address _gauge) internal {
        ...
        if (_claimable > IGauge(_gauge).left() && _claimable > DURATION) {
            claimable[_gauge] = 0;
            IERC20(rewardToken).forceApprove(_gauge, _claimable);
            IGauge(_gauge).notifyRewardAmount(_claimable);
            IERC20(rewardToken).forceApprove(_gauge, 0);
