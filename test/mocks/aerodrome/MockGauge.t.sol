...
contract MockGauge is IGauge, ERC2771Context, ReentrancyGuard {
    ...
    function _claimFees() internal returns (uint256 claimed0, uint256 claimed1) {
        ...
        if (claimed0 > 0 || claimed1 > 0) {
            ...
            if (_fees0 > DURATION) {
                fees0 = 0;
                IERC20(_token0).forceApprove(feesVotingReward, _fees0);
            ...
            if (_fees1 > DURATION) {
                fees1 = 0;
                IERC20(_token1).forceApprove(feesVotingReward, _fees1);
