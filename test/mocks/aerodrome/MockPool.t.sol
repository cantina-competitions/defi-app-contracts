...
import {IPoolCallee} from "../../../src/interfaces/aerodrome/IPoolCallee.sol";
import {IPoolFactory} from "../../../src/interfaces/aerodrome/IPoolFactory.sol";
import {MockPoolFees} from "./MockPoolFees.t.sol";
...
contract MockPool is IPool, ERC20Permit, ReentrancyGuard {
    ...
    function claimFees() external returns (uint256 claimed0, uint256 claimed1) {
        ...
        if (claimed0 > 0 || claimed1 > 0) {
            ...
            MockPoolFees(poolFees).claimFeesFor(sender, claimed0, claimed1);
    ...
    function _update0(uint256 amount) internal {
        ...
        if (amount == 0) return;
        IERC20(token0).safeTransfer(poolFees, amount); // transfer the fees out to MockPoolFees
